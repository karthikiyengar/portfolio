...
export default (props) => (
  <Container>
    ...
    <Content>
      ...
      <Meta role="All" context="Academic" date="JUN '13" platforms="Android, Web" />
      <Description>
        <li>An Android application which provides <strong>authorization using QR Barcodes</strong></li>
        <li>Propsed a research paper and secured <strong>1st position in the Technical Presentation competition</strong> organized by the college.</li>
        <li>Project selected as an entry to the <strong>Eureka Competition at IIT Mumbai</strong> by the college</li>
      </Description>
      <ImageContainer>
