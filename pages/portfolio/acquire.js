    ...
    <Content>
      ...
      <Description>
        <li>Completely
          ...
          Universal React/Redux Application</li>
        <li>Developed and delivered within
          <strong>1 calendar week</strong>
        </li>
        <li>Optimized for enhanced
          <strong>SEO</strong>
          performance</li>
        <li>Offers product
          <strong>recommendations on the fly</strong>
          based on customer preferences</li>
      </Description>
      <ImageContainer>
