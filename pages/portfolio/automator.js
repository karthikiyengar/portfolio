...
export default(props) => (
  <Container>
    <Header/>
    <Content>
      <P>Automator is a home automation system which helps you control electrical
        appliances digitally</P>
      <Meta
        role="All"
      ...
      <Description>
        ...
        <li>Control connected applicances using a
          <strong>remote control</strong>
        </li>
        <li>LDRs allow you to automatically control appliances depending on
          <strong>room luminosity</strong>
        </li>
        <li>Can program the application to turn on or off using a
          <strong>timer</strong>
        </li>
        <li>Project secured
          <strong>1st position in graduation thesis</strong>
          and presentation</li>
      </Description>
      <ImageContainer>
