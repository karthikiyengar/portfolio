...
export default(props) => (
  <Container>
    <Header/>
    <Content>
      <P>Marketing and outreach applications for multiple firms, as a part of Prolite
        Entertainment</P>
      <Meta
        role="Mobile"
        context="Freelance"
      ...
      <Description>
        ...
        <li>Created
          <strong>marketing and consumer outreach</strong>
          applications for improving brand visibility</li>
        <li>
          <strong>Rapid development and iteration</strong>
          based on client feedback</li>
        <li>Worked closely with clients to develop an
