...
export default(props) => (
  <Container>
    <Header/>
    <Content>
      <P>Threatbar is a bug-bounty platform that helps organizations build
        intellectual properties and customer loyalties by enhancing security</P>
      ...
      <Description>
        ...
        <li>Multiple
          ...
          with separate interfaces for clients and end-users</li>
        <li>Interactions between end-users, clients and Threatbar by comments, and
          ticket assignment</li>
        <li>
          <strong>Comprehensive Dashboard</strong>
          for clients with charts that provide metrics to track usage</li>
        <li>Extensive sorting and filtering capabilities with pagination</li>
        <li>Emphasis on
          <strong>security, and safe coding practices</strong>
          to prevent vulnerabilities</li>
      </Description>
