...
export default (props) => (
  <Container>
    ...
    <Content>
      ...
      <Description>
        <li>Participated the <strong>Code for Good Hackathon 2014</strong> organized by <strong>J.P Morgan</strong></li>
        <li>Secured <strong>3rd position among 20 teams</strong> across Mumbai, in a 24-hour coding event</li>
        <li>Developed an Android application with <strong>offline caching and sync</strong>, handling poor connectivity</li>
        <li><strong>Administrative backend</strong> with data analysis</li>
      </Description>
